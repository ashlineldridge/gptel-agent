...
- Ensure that gptel is up to date.  Set =gptel-model= and =gptel-backend= to use
  your preferred LLM.  See [[https://github.com/karthink/gptel][gptel's README]] for details.
